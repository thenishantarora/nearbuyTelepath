...
//		w2v.show(false);
		try {
			model.write().overwrite().save("/Users/nishantarora/Downloads/W2VfinalModel");
...
//			model.write().overwrite().save("/Users/nishantarora/Downloads/w2vModel");
			hashingTF.write().overwrite().save("/Users/nishantarora/Downloads/hashFinalModel");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		try {
//			model.write().overwrite().save("/Users/nishantarora/Downloads/w2vModel");
			idfModel.write().overwrite().save("/Users/nishantarora/Downloads/idfFinalModel");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
...
//		predictions.show(false);
		...
		try {
			gbtModel.write().overwrite().save("/Users/nishantarora/Downloads/Final");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
