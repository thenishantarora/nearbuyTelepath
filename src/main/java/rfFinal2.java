...
//		w2v.show(false);
		try {
			model.write().overwrite().save("/Users/nishantarora/Downloads/rfW2VModel2");
...
//			model.write().overwrite().save("/Users/nishantarora/Downloads/w2vModel");
			hashingTF.write().overwrite().save("/Users/nishantarora/Downloads/RFhashModel2");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		try {
//			model.write().overwrite().save("/Users/nishantarora/Downloads/w2vModel");
			idfModel.write().overwrite().save("/Users/nishantarora/Downloads/RFidfModel2");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
...
//		GBTClassifier gbt = new GBTClassifier().setLabelCol("label").setFeaturesCol("features");
//		GBTClassificationModel gbtModel = gbt.fit(trainingDF);
		RandomForestClassifier forest = new RandomForestClassifier().setLabelCol("label").setFeaturesCol("features").setMaxDepth(15).setNumTrees(15);
...
//		predictions.show(false);
		...
		try {
			gbtModel.write().overwrite().save("/Users/nishantarora/Downloads/rfFinal2");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
